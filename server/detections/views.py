...
class HealthView(APIView):
    ...
    def get(self, request):
        try:
            from .engine import _get_model, _build_gradcam_model
            _get_model()
...
class DetectView(APIView):
    ...
    def post(self, request):
        ...
        # Persist the uploaded image — the ML pipeline needs a real file path.
        ...
        # ── Stage 4: low confidence warning ───────────────────────────────────
        ...
        # ── Stage 5: high-confidence success ──────────────────────────────────
